...
export default {
  beforeMount() {
    const themeColor = this.$settings.get("themeColor", "green");
    this.sidebarColors.forEach(item => {
      item.active = item.color === themeColor;
    });
  },
  ...
  methods: {
    ...
    changeSidebarBackground(item) {
      this.$settings.set("themeColor", item.color, true);
